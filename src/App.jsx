...
function MyAttendance() {
  ...
  const loadSessions = async () => {
    ...
    const data = await db.getMyAttendance(profile.id).catch(() => []);
    setSessions(data);
    setLoading(false);
  };
  ...
  return (
    <div>
      <div style={{ marginBottom: 28 }}>
        <div style={{ fontSize: 11, color: "#C9A84C", letterSpacing: 2, textTransform: "uppercase", marginBottom: 8 }}>◈ Intersection Program</div>
        <h1 style={{ fontFamily: "'DM Sans',sans-serif", fontSize: 26, fontWeight: 700, color: "#F0EBE0", marginBottom: 6 }}>My Attendance Sheet</h1>
        <p style={{ color: "#8A9BB5", fontSize: 14 }}>Log your sessions — INJAZ team will verify them</p>
      </div>

...
const _supabaseClient = (SUPABASE_URL && SUPABASE_KEY) ? createClient(SUPABASE_URL, SUPABASE_KEY, {
  auth: {
  ...
  global: {
    headers: { 'x-my-custom-header': 'injaz-platform' },
  },
  db: { schema: 'public' },
...
export default function App() {
  ...
  useEffect(() => {
    ...
    // Auto-refresh session every 10 minutes to prevent expiry

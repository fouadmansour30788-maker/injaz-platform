...
// ── Design tokens ─────────────────────────────────────────────
const C = {
  bg: "#F7F5F2", bgCard: "#FFFFFF", bgSidebar: "#FFFFFF",
  border: "#E8E4DE", borderLight: "#F0EDE8",
  text: "#1A1A2E", textSub: "#6B6B80", textMuted: "#9999AA",
  primary: "#C8392B", primaryLight: "#FDECEA", primaryDark: "#A52D21",
  accent: "#2C5F8A", accentLight: "#EBF3FA",
  green: "#27AE60", greenLight: "#E8F8EF",
  amber: "#E67E22", amberLight: "#FEF3E2",
  purple: "#7B2D8B", purpleLight: "#F5EDF7",
...
const globalStyles = `
  ...
  * { box-sizing: border-box; }
  ...
  .btn-primary {
    background:${C.primary}; color:#fff; border-radius:${C.radiusSm};
    padding:10px 20px; font-size:14px; font-weight:600;
    transition:all .2s; display:inline-flex; align-items:center; gap:8px;
  }
  .btn-primary:hover { background:${C.primaryDark}; transform:translateY(-1px); box-shadow:${C.shadowMd}; }
  ...
  .btn-secondary:hover { border-color:${C.primary}; color:${C.primary}; background:${C.primaryLight}; }
  ...
  .input-field:focus { border-color:${C.primary}; box-shadow:0 0 0 3px ${C.primaryLight}; }
  ...
  .card {
    ...
    box-shadow:${C.shadow}; padding:24px;
  }
  ...
  .nav-item.active { background:${C.primaryLight}; color:${C.primary}; font-weight:600; }
  ...
  .badge-red { background:${C.primaryLight}; color:${C.primary}; }
  .badge-blue { background:${C.accentLight}; color:${C.accent}; }
  .badge-amber { background:${C.amberLight}; color:${C.amber}; }
  .badge-purple { background:${C.purpleLight}; color:${C.purple}; }
  .badge-gray { background:${C.borderLight}; color:${C.textSub}; }

  .tag {
    display:inline-flex; align-items:center; gap:4px; padding:4px 10px;
    background:${C.borderLight}; border-radius:20px; font-size:12px; color:${C.textSub};
  }
  ...
  .toast-success { background:#fff; border-color:${C.green}; color:${C.text}; }
  .toast-error { background:#fff; border-color:${C.primary}; color:${C.text}; }
  .toast-info { background:#fff; border-color:${C.accent}; color:${C.text}; }
...
function AuthScreen({ onAuth }) {
  ...
  return (
    <div style={{ minHeight: "100vh", background: C.bg, display: "flex" }}>
      <style>{globalStyles}</style>
      {/* Left panel */}
      <div style={{ flex: "0 0 480px", background: `linear-gradient(160deg, #C8392B 0%, #8B1A1A 100%)`, padding: 60, display: "flex", flexDirection: "column", justifyContent: "space-between" }}>
        <div>
...
function Shell({ navItems, userLabel, userSub, accentColor = C.primary, children, activePage, setActivePage }) {
  ...
  return (
    <div style={{ display: "flex", minHeight: "100vh", background: C.bg }}>
      ...
      {/* Sidebar */}
      <div className={`sidebar ${sidebarOpen ? "open" : ""}`} style={{ width: 240, background: C.bgSidebar, borderRight: `1px solid ${C.border}`, display: "flex", flexDirection: "column", padding: "24px 16px", position: "sticky", top: 0, height: "100vh", flexShrink: 0, overflowY: "auto" }}>
        {/* Logo */}

...
function Shell({ navItems, userLabel, userSub, accentColor = C.primary, children, activePage, setActivePage }) {
  ...
  return (
    <div style={{ display: "flex", minHeight: "100vh", background: "#080F1E" }}>
      ...
      {/* Mobile hamburger */}
      <button onClick={() => setSidebarOpen(true)} style={{ display: "none", position: "fixed", top: 16, left: 16, zIndex: 60, background: "#fff", border: "1px solid rgba(201,168,76,0.12)", borderRadius: C.radiusSm, padding: "8px 10px", cursor: "pointer" }}
    ...
    <div>
      ...
      <div style={{ display: "flex", gap: 8, flexWrap: "wrap", marginBottom: 24 }}>
        {JOURNEY_STAGES.map(stage => (
          <div key={stage.id} style={{ background: "#fff", border: "1px solid rgba(201,168,76,0.12)", borderRadius: C.radiusSm, padding: "10px 16px", textAlign: "center", minWidth: 100 }}>
